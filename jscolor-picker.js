...
window.jscolor = (function () { // BEGIN window.jscolor
  var jsc = {
    ...
    detachGroupEvents: function (groupName) {
      if (jsc._attachedGroupEvents.hasOwnProperty(groupName)) {
        for (
          var i = 0; i < jsc._attachedGroupEvents[groupName].length; i += 1
        ) {
    ...
    jscolor: function (targetElement, opts) {
      ...
      function drawPicker() {
        ...
        p.padM.style.top = "0";
        p.padM.style.width =
          (THIS.padding + 2 * THIS.insetWidth + THIS.width +
        ...
        p.crossBY.style.left = p.crossBX.style.top =
          (Math.floor(crossOuterSize / 2) -
            Math.floor(THIS.pointerThickness / 2) - THIS.pointerBorderWidth) +
          "px";
        ...
        p.crossLY.style.width = p.crossLX.style.height = THIS.pointerThickness +
          "px";
        p.crossLY.style.left = p.crossLX.style.top =
          (Math.floor(crossOuterSize / 2) -
            Math.floor(THIS.pointerThickness / 2)) + "px";
        p.crossLY.style.top = p.crossLX.style.left = THIS.pointerBorderWidth +
          "px";
        ...
        p.sldM.style.top = "0";
        p.sldM.style.width =
          (THIS.sliderSize + padToSliderPadding / 2 + THIS.padding +
      ...
      function redrawSld() {
        ...
        if (sldComponent) {
          ...
          jsc.picker.sldPtrOB.style.top =
            (y - (2 * THIS.pointerBorderWidth + THIS.pointerThickness) -
  ...
  jsc.jscolor.presets["light"] = {
    backgroundColor: "#FFFFFF",
    insetColor: "#BBBBBB",
  }; // default color scheme
  jsc.jscolor.presets["dark"] = {
  ...
  jsc.jscolor.presets["thin"] = {
    borderWidth: 1,
    insetWidth: 1,
    pointerBorderWidth: 1,
  }; // default thickness
  jsc.jscolor.presets["thick"] = {
    borderWidth: 2,
    insetWidth: 2,
